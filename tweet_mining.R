...
# save data
dir()
iran_tweets <- iran_tweets[,c(1:16, 32:34)]
write_tsv(iran_tweets, 'data/iran_tweets.tsv')
...
# save data
iran_tweets_ny <- iran_tweets_ny[,c(1:16, 32:34)]
write_tsv(iran_tweets_ny, 'data/iran_tweets_ny.tsv')
# load data
iran_tweets_ny <- read_tsv('data/iran_tweets_ny.tsv')

iran_tweets_az <- search_tweets('iran', type = "recent", n = 10000, lang='en',
...
# save data
iran_tweets_az <- iran_tweets_az[,c(1:16, 32:34)]
write_tsv(iran_tweets_az, 'data/iran_tweets_az.tsv')
# load data
iran_tweets_az <- read_tsv('data/iran_tweets_az.tsv')
